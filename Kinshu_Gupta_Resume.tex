...
\begin{center}
    ...
    $|$
    \hspace{.5pt} \href{tel:18609959086}{\color{blue}1-860-995-9086}
    $|$
...
\section{Extracurriculars \& Projects}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        {\textbf{Democracy Front} $|$ \emph{Co-Founder}}{}
          \resumeItemListStart
            \resumeItem{Developed political fundraising app to successfully qualify for 2nd round pitch to Pear Venture Capital at Harvard delivering legislature info + enabling grassroots donor contributions to candidates, political parties, PACs or NGOs}
          \resumeItemListEnd
      ...
      \resumeProjectHeading
        {\textbf{Cucumber Sports} $|$ \emph{App Developer}}{}
          \resumeItemListStart
      ...
      \resumeProjectHeading
      {\textbf{Amazon Alexa Hackathon} $|$ \emph{Participant}}{}
        \resumeItemListStart
...
%   \resumeSubHeadingListStart
%     \small{\item{
%         \textbf{Programming: }{Python, Java, JavaScript, C, R, SQL} \\ \vspace{3pt}
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Programming }{Python, Java, JavaScript, C, R, SQL} \\
        \textbf{Technologies }{Arduino, Raspberry Pi, Git, Selenium, React} \\ 
        \textbf{Certifications }TensorFlow Machine Learning, AWS Developer Associate\vspace{3pt}
